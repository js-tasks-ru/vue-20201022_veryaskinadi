<template>
  <div  class="dropdown" @click="showOptions()" :class = "show ? 'show' : ''">
    <button 
      type="button" class="button dropdown__toggle" 
      :class = "countIcon ? 'dropdown__toggle_icon' : ''"
    >
    ...
    <div class="dropdown__menu" :class = "show ? 'show' : ''">
      <button 
        ...
        :class = "countIcon ? 'dropdown__item_icon' : ''" 
        type="button"
      >
...
export default {
  ...
  computed: {
    countIcon() {
      return this.options.filter(option => option.icon).length
    },
    text() {
      return this.value ? " - " + this.options.find(option => option.value === this.value).text : ''
    },
    icon() {
      return this.value ? this.options.find(option => option.value === this.value).icon : null
    },
  },
